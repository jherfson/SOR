...
SUBROUTINE FIND_ENTHALPY(vec,enthalpy,conf)
...
CHARACTER(20), 	                       INTENT(OUT)   :: enthalpy
...
CALL SEARCH_IN_VECT(vec,'Final enthalpy =',rec,temp,c_start)
